...
public class RoundedDrawable extends Drawable {
    ...
    public static final String TAG = LogUtils.internalMakeLogTag(RoundedDrawable.class);
    ...
    private RectF mTopCornerRounded;
    private boolean mAllRoundedCorners;
    ...
    private void updateShaderMatrix() {
        ...
        mTopCornerRounded = new RectF(mDrawableRect.left, mDrawableRect.top + mCornerRadius, mDrawableRect.right, mDrawableRect.bottom);
        mBitmapShader.setLocalMatrix(mShaderMatrix);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (mOval) {
            ...
            if (mBorderWidth > 0) {
                ...
                if (!mAllRoundedCorners) {
                    canvas.drawRect(mTopCornerRounded, mBitmapPaint);
                    canvas.drawRoundRect(mDrawableRect, mCornerRadius, mCornerRadius, mBitmapPaint);
                } else {
                    //BACK TO WHOLE CORNERS RADIUS Delete these two lines above and uncomment line under
                    canvas.drawRoundRect(mDrawableRect, mCornerRadius, mCornerRadius, mBitmapPaint);
                }
            }
        }
